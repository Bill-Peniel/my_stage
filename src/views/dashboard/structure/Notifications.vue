  ...
  setup() {
    ...
    const notifications = ref([
      ...
      },
      {
        ...
        message: 'L\'évaluation du stagiaire Jean Dupont a été soumise avec succès.',
      ...
      },
      {
        ...
        message: 'N\'oubliez pas d\'évaluer le stagiaire Marie Martin avant la fin de son stage.',
