  ...
  <div class="bg-white shadow rounded-lg">
    <div class="px-6 py-4 border-b border-gray-200">
      <div class="flex justify-between items-center">
        <h2 class="text-xl font-semibold text-gray-800">Notifications DPAF</h2>
  ...
  setup() {
    ...
    const notifications = ref([
      ...
      },
      {
        ...
        message: 'Marie Martin a été affectée avec succès à la structure Finance.',
      ...
      },
      {
        ...
        message: 'L\'évaluation du stage de Paul Dubois est en attente.',
